...
# GitHub App which listens for PR events and adds to the comments
class GHAapp < Sinatra::Application
  ...
  before '/event_handler' do
    return if request.env['REQUEST_METHOD'] == 'GET'
  ...
  post '/event_handler' do
    handle_pr_events(@payload) if request.env['HTTP_X_GITHUB_EVENT'] == 'pull_request'
